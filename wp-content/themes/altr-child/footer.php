...
<footer id="colophon" class="footer-credits container-fluid">
    <div class="container grid py-4">
        <div class="info">
            <div class="social c-flex">
                <figure class="logo">
                    <picture>
                        <img src="https://www.liligrow.es/wp-content/uploads/2023/07/white_logo-scaled.webp"
                            alt="imagen logo liligrow" class="custom-logo" loading="lazy" />
                    </picture>
                </figure>
                <div class="networks r-flex gap-16">
                    <a href="https://www.facebook.com/profile.php?id=61553575602875" class="facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-facebook"
                            width="32" height="32" viewBox="0 0 24 24" stroke-width="1.50" stroke="#FFFFFF" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3"></path>
                        </svg>
                    </a>
                    <a href="https://wa.me/603014125" class="whatsapp">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-whatsapp"
                            width="32" height="32" viewBox="0 0 24 24" stroke-width="1.50" stroke="#FFFFFF"
                    ...
                    <a href="https://www.instagram.com/liligrow.es/" class="instagram">
                    ...
                    <a href="https://www.tiktok.com/@liligrow" class="tiktok">
                        <svg width="32px" height="32px" class="icon icon-tabler icon-tabler-brand-instagram" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="logo" fillRule="nonzero">
                                    <path d="M14,15.5986129 L14,14.1133768 C13.4492134,14.040368 12.8937601,14.0024884 12.3374825,14 C5.53458031,14 0,19.1804477 0,25.5469912 C0,29.4523859 2.08560208,32.9095062 5.26712374,35 C3.13682443,32.8679456 1.95248926,30.057585 1.95420355,27.138627 C1.95420355,20.862785 7.33129202,15.7451306 14,15.5986129" fill="#00F2EA"></path>
                                    <path d="M14.3270124,32 C17.2025642,32 19.5483859,29.7265698 19.6552148,26.893337 L19.6649265,1.60131615 L24.3141914,1.60131615 C24.2149367,1.07323659 24.1646956,0.537213101 24.1641012,0 L17.8144025,0 L17.8038079,25.2928983 C17.6978619,28.1252536 15.3511573,30.3978064 12.4764884,30.3978064 C11.6134296,30.3981458 10.7633314,30.1891169 10,29.7888676 C10.9999544,31.1753424 12.6105704,31.998378 14.3270124,32 M32.9991171,10.1861256 L32.9991171,8.7804771 C31.2904862,8.78205509 29.6185303,8.28804731 28.1882845,7.35903482 C29.4422255,8.79389849 31.1305958,9.78588899 33,10.1861256" fill="#00F2EA"></path>
                                    <path d="M28,7.71784336 C26.6016465,6.13450916 25.8314253,4.10280973 25.8323547,2 L24.1350558,2 C24.579153,4.34872233 25.9758497,6.41501163 28,7.71784336 M12.3253083,20.0652472 C9.38563022,20.0686094 7.00339763,22.426024 7,25.3350766 C7.00190968,27.2938688 8.10083201,29.0902144 9.85378743,30 C9.1988984,29.1062913 8.84622242,28.0306091 8.84615385,26.9266592 C8.84906616,24.0172662 11.2314406,21.6593213 14.1714621,21.6559582 C14.7201996,21.6559582 15.2460364,21.7457353 15.7428068,21.9000125 L15.7428068,15.4996887 C15.2222255,15.4267223 14.6972334,15.3888647 14.1714621,15.3863778 C14.0789783,15.3863778 13.988256,15.3916075 13.896653,15.3933508 L13.896653,20.3093015 C13.388489,20.1492295 12.8585935,20.0669285 12.3253083,20.0652472" fill="#FF004F"></path>
                                    <path d="M32.1532084,11.0008735 L32.1532084,15.8838834 C28.868262,15.8838834 25.8255034,14.841767 23.3402168,13.072877 L23.3402168,25.8412053 C23.3402168,32.2179445 18.1107231,37.4058149 11.6817395,37.4058149 C9.19733366,37.4058149 6.89346776,36.6283768 5,35.3093527 C7.2006955,37.6633081 10.2910883,39.0007866 13.5276504,39 C19.956634,39 25.1870084,33.8121292 25.1870084,27.4362636 L25.1870084,14.6679353 C27.7544407,16.4991162 30.8377082,17.4825603 34,17.4789417 L34,11.1947963 C33.3659085,11.1947963 32.7494306,11.1266613 32.1532084,11" fill="#FF004F"></path>
            ...
            <div class="categories c-flex">
                <h3 class="mb-1">Categorías de productos</h3>
                <?php get_product_categories_list() ?>
            </div>
            <div class="account c-flex">
            ...
            <div class="contact c-flex gap-16">
                <h3 class="mb-1">Información de contacto</h3>
                <div class="info r-flex gap-16">
                    <div class="phone-container r-flex gap-8">
                        <div class="phone">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone-call"
                                width="16" height="16" viewBox="0 0 24 24" stroke-width="1.50" stroke="#FFFFFF"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path
                    ...
                    <div class="address-container r-flex gap-8">
                        <div class="address">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-address-book" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="mail-container r-flex gap-8">
                        <div class="mail">
                        ...
                        <div class="c-flex gap-4">
                            <h4 class="m-0 title">Email</h4>
                            <span class="text">
                                <a href="mailto:info@liligrow.es">info@liligrow.es</a>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <hr class="divider" style="grid-area: divider;"></hr>
        <div class="copyright">
            <span>Copyright &copy; <span id="year"></span>. Todos los derechos reservados</span>
            <span>Las semillas de marihuana se venden con fines decorativos y para coleccionismo. Liligrow.es no se hace
                responsable de su uso o cultivo. Los productos de CBD no son medicamentos y no pueden diagnosticar,
                tratar o curar enfermedades.</span>
        </div>
        <div class="legal">
            <a id="legal-notice" href="<?php echo home_url() . "/aviso-legal" ?>">Aviso legal</a>
            <a id="privacy-policy" href="<?php echo home_url() . "/politicas-de-privacidad" ?>">Politicas de privacidad</a>
            <a id="return-policy" href="<?php echo home_url() . "/politicas-de-devolucion" ?>">Politicas de devolución</a>
            <a id="cookies-policy__link" href="<?php echo home_url() . "/politica-de-cookies" ?>">Politicas de cookies</a>
        </div>
    </div>
</footer>
</div><!-- end page-wrap -->
    ...
    <script>
        fetch('https://www.liligrow.es/wp-json/wc-analytics/reports/products?orderby=items_sold&order=desc&after=2024-01-01T00%3A00%3A00&page=1&per_page=10&extended_info=true&_locale=user', {
            ...
            .then(data => {
                ...
                fetch('https://liligrow.es/wp-admin/admin-ajax.php', {
                    method: 'POST',
                    body: new URLSearchParams({
                        action: 'get_top_sellers',
                        top_sellers: JSON.stringify(topSellers)
                    }),
                })
                .then(response => response.text())
                .then(data => {
                    const container = document.querySelector('#best-sellers-container .elementor-widget-container');
                    const sanitiziedHTML = data.substring(0, data.length - 1);
